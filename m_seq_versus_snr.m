...
parfor k=1:TrainSet
    ...
    ansVec = [0 1];
      ...
      trainData2 = [trainData2 (diag(Sn))];
      trainData3 = [trainData3 abs(corrVec)];
      trainData4 = [trainData4 abs(fft(corrVec))];
...
parfor k=1:TestSet
    ...
    ansVec = [1 0];
      ...
      testData4 = [testData4 abs(fft(corrVec))];
    ...
    sortedCorr = sort((corrVec),'ascend');
...
legend('Proposed method','Deep learning method based on cross-correlation','Deep learning based on FFT-processed cross-correlation', ...
